...
export default async function Home() {
  ...
  const africa = data.filter(country => country.region ==="Oceania")
...
const countries = africa.map(country =>(
  ...
  return (
    ...
    <div>
      <h1 className='flex flex-col items-center h-[50px] justify-center m-4 bg-sky-800 text-white'>Oceania Countries
      </h1>
